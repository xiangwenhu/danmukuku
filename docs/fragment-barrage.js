(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.fragmentBarrage = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.BUILTIN_CLASS = void 0;
var BUILTIN_CLASS;
(function (BUILTIN_CLASS) {
    BUILTIN_CLASS["FRAME"] = "barrage-frame barrage-frame-common";
    BUILTIN_CLASS["DEFAULT_BARRAGE"] = "barrage-item";
    BUILTIN_CLASS["STAGE1_CLASS"] = "barrage-animation-1";
    BUILTIN_CLASS["STAGE2_CLASS"] = "barrage-animation-2";
...
function toBarrageItem(item) {
    return typeof item === "string" ? { content: item } : item;
}
var BarrageManager = /** @class */ (function () {
    function BarrageManager() {
        this.layers = [];
        this.batch = this.batch.bind(this);
    }
    BarrageManager.prototype.batch = function (data) {
        var _this = this;
        // 改进批量
    ...
    BarrageManager.prototype.send = function (content) {
        if (this.status !== 1) {
            return;
        }
        var contents = null;
        if (Array.isArray(content)) {
            contents = content.map(function (d) { return toBarrageItem(d); });
        }
        else {
    ...
    BarrageManager.prototype.init = function (container, option) {
        var _this = this;
    ...
    BarrageManager.prototype.start = function () {
        if (this.status === 1) {
            return;
        }
    ...
    BarrageManager.prototype.stop = function () {
    ...
    BarrageManager.prototype.pause = function () {
        if (this.status !== 1) {
            return;
        }
    ...
    BarrageManager.prototype.continue = function () {
        if (this.status !== 2) {
            return;
        }
...
var CommonLayer = /** @class */ (function (_super) {
    ...
    CommonLayer.prototype.init = function (option) {
        ...
        this.sampleBarrageItem.className = option.className || constant_1.BUILTIN_CLASS.DEFAULT_BARRAGE;
        var _a = this, HEIGHT = _a.HEIGHT, WIDTH = _a.WIDTH;
        this.option = Object.assign({}, DEFAULT_OPTION, option);
        this.createNewFrame();
        this.registerAnimationEvents();
        this.getBaseMeasure(constant_1.BUILTIN_CLASS.DEFAULT_BARRAGE);
    ...
    CommonLayer.prototype.send = function (queue) {
        ...
        var poolItems = el.querySelectorAll(constant_1.BUILTIN_CLASS.DEFAULT_BARRAGE + ".hide");
        ...
        if (poolLength > 0) {
            ...
            for (var index = 0; index < realLength; index++) {
                ...
                newItem.class = constant_1.BUILTIN_CLASS.DEFAULT_BARRAGE;
        ...
        if (queue.length > 0) {
            ...
            var newItems = queue.map(function (item) {
                ...
                var newItem = _this.createBarrageNode(item, x, top);
    ...
    CommonLayer.prototype.createBarrageNode = function (item, left, top) {
        var el = item.render && this.createBarrageNodeWithRender(item, left, top);
        if (el) {
            return el;
        }
        var _a = this.getNewTopLeft(left, top), t = _a.top, l = _a.left;
        el = this.sampleBarrageItem.cloneNode();
    ...
    CommonLayer.prototype.createBarrageNodeWithRender = function (item, left, top) {
        var data = { left: left, top: top, class: item.className, style: item.style };
        if (typeof item.render === "function") {
            var el = item.render(data);
            if (el instanceof HTMLElement) {
                if (!el.classList.contains(constant_1.BUILTIN_CLASS.DEFAULT_BARRAGE)) {
                    el.classList.add(constant_1.BUILTIN_CLASS.DEFAULT_BARRAGE);
                }
                return el;
            }
            if (typeof el === "string") {
    ...
    CommonLayer.prototype.wrapperHTMLStringBarrageNode = function (left, top, content) {
        var _a = this.getNewTopLeft(left, top), t = _a.top, l = _a.left;
        var el = this.sampleBarrageItem.cloneNode();
    ...
    CommonLayer.prototype.recycle = function () {
        ...
        this.clearTicket = window.setInterval(function () {
            _this.frames
                ...
                var allItems = frame.querySelectorAll("." + constant_1.BUILTIN_CLASS.DEFAULT_BARRAGE + ":not(.hide)");
    ...
    CommonLayer.prototype.clear = function (el) {
        if (this.option.reuse) {
            el.querySelectorAll("." + constant_1.BUILTIN_CLASS.DEFAULT_BARRAGE + ":not(.hide)").forEach(function (child) {
                child.classList.add("hide");
    ...
    CommonLayer.prototype.registerAnimationEvents = function () {
        var _this = this;
...
var Layer = /** @class */ (function () {
    ...
    Layer.prototype.remove = function (itemId) {
        var el = this.container.querySelector("[barrage-id='" + itemId + "']");
        if (el) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.removeListener = exports.addListener = exports.enqueue = exports.dequeue = void 0;
var queue = [];
var callBacks = [];
var requestId = null;
function dequeue() {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.TraceStrategy = void 0;
var TraceStrategy;
(function (TraceStrategy) {
    TraceStrategy["random"] = "random";
    TraceStrategy["queue"] = "queue";
...
var TraceManager = /** @class */ (function () {
    ...
    TraceManager.prototype.resize = function (option) {
        ...
        var index = this.findMinTraceIndex();
    ...
    TraceManager.prototype.findMinTraceIndex = function () {
        // sort ?
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.measureElement = exports.getTranslateX = exports.get2DTranslate = exports.getRemValue = exports.pxToRem = exports.pxToNumer = void 0;
